...
const Herobar = () => {
    ...
    useEffect(() => {
        ...
        elements.forEach((el, index) => {
            gsap.fromTo(
                el,{ x: index % 2 === 0 ? -200 : 200, opacity: 0 },
                {
                    x:0,
                    opacity: 1,
                    duration: 1,
                ...
                <div className="innerconatiner mx-auto">
                    <div className="headlinerbox mt-8 mb-5 mx-auto overflow-x-hidden">
                        ...
                        <div className="paralinebox mt-5 text-center ">
                            <div className="firtspoint flex items-center text-center justify-center gap-4 animated-div">
                            ...
                            <div className="firtspoint mt-4 flex items-center text-center justify-center animated-div gap-4">
                                <p className='text-2xl '><PiMicrophoneStageDuotone /></p>
                            ...
                            <div className="firtspoint mt-4 flex items-center text-center animated-div justify-center gap-4">
                                <p className='text-2xl '><PiMicrophoneStageDuotone /></p>
